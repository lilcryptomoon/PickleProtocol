...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pickleprotocol-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pickleprotocol-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pickleprotocol transaction") + "\n" +
              "  pickleprotocol-tx [options] -create [commands]   " + _("Create hex-encoded pickleprotocol transaction") + "\n" +
              "\n";

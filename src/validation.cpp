...
#if defined(NDEBUG)
# error "PickleProtocol cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "PickleProtocol Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PCK additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("pickleprotocol-scriptch");

...
"""Verify that starting pickleprotocol with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pickleprotocol with -h for help text")
        ...
        self.log.info("Start pickleprotocol with -version for version information")
